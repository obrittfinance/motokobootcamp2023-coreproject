...
`);
  ...
  async syncTime(canisterId) {
    const CanisterStatus = await import("./canisterStatus-NI3F4UHR.js");
...
async function fetchCandid(canisterId, agent) {
  ...
  const status = await canisterStatus_exports.request({
    agent,
 ...
 * @license MIT
 */
//# sourceMappingURL=chunk-UCX7BOBO.js.map
